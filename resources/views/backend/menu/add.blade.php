                                                            ...
                                                            <div class="col-sm-3 col-md-3">
                                                                <div class="panel-group" id="menu_accordion">
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse" data-parent="#menu_accordion" href="#collapseOne"><span style="padding-right: 2%;" class="glyphicon glyphicon-folder-close">
                                                             </span>Page</a>
                                                                            </h4>
                                                                        </div>
                                                                        <div id="collapseOne" class="panel-collapse collapse in">
                                                                            ...
                                                                            <div id="content">
                                                                                <ul id="tabs" class="nav nav-tabs dynamicpages" data-tabs="tabs">
                                                                                    <li class="active"><a href="#red" data-toggle="tab">Recent</a></li>
                                                                                    <li><a href="#orange" style="padding-left: 0;"  data-toggle="tab">View all</a></li>
                                                                                    <li><a href="#yellow" style="padding-left: 0; padding-right: 0" data-toggle="tab">Search</a></li>

                                                                                </ul>
                                                                                <div id="my-tab-content" class="tab-content">
                                                                                    <div class="tab-pane active pages" id="red">
                                                                                        <ul class="check unstyled centered" style="list-style: none;margin-left: -6%;">
                                                                                            @php $i = 0; @endphp
                                                                                            @if(@isset($recent))
                                                                                                @foreach($recent as $k => $v)
                                                                                                    <li>
                                                                                                        <input class="styled-checkbox" type="checkbox" data-id="{{ $v->id }}" id="page-{{ $i }}">
                                                                                                        <label for="page-{{ $i }}">{{ $v->title }}</label>
                                                                                                    </li>
                                                                                                    @php $i++; @endphp
                                                                                                @endforeach
                                                                                            @endif
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <button onclick="checkAll(this)" class="btn btn-primary" style="border-radius: 0px;width: 100%; margin-bottom: 6%;margin-left: 5%;">Select</button>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <button type="button" onclick="addPageToMenu(this)" class="btn btn-primary" style="border-radius: 0px;width: 100%;">Add</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="tab-pane pages" id="orange">
                                                                                        <ul class="check unstyled centered"  style="list-style: none;margin-left: -6%;">
                                                                                            @php $i = 0; @endphp
                                                                                            @if(@isset($all))
                                                                                                @foreach($all as $key => $value)
                                                                                                    <li>
                                                                                                        <input class="styled-checkbox" type="checkbox" data-id="{{ $value->id }}" id="page-{{ $i }}">
                                                                                                        <label for="page-{{ $i }}">{{ $value->title }}</label>
                                                                                                    </li>
                                                                                                    @php $i++;@endphp
                                                                                                @endforeach
                                                                                            @endif
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6 view-all">
                                                                                                <button onclick="checkAll(this)" class="btn btn-primary buttons" style="margin-bottom: 6%;margin-left: 5%;">Select</button>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <button type="button" onclick="addPageToMenu(this)" class="btn btn-primary buttons">Add</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="tab-pane" id="yellow">
                                                                                        <div class="form-group" style="margin-top: 4%;padding-bottom: 4%;margin-left: 4%;margin-right: 4%;">
                                                                                            <input type="text" list="pages"  placeholder="Search Page" style="background-color: #fff;" class="form-control">
                                                                                            <datalist id="pages">
                                                                                                @if(@isset($all))
                                                                                                    @foreach($all as $key => $value)
                                                                    ...
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse" data-parent="#menu_accordion" href="#collapseFour"><span style="padding-right: 1%;"  class="glyphicon glyphicon-file">
                                                            </span>External</a>
                                                                            </h4>
                                                                        </div>
                                                                            ...
                                                                            <div class="row" style="margin-top: 5%">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group" style="margin-left: 4%;margin-right: 4%;">
                                                                                        <input type="text" placeholder="Title" name="title" style="background-color: #fff;" class="form-control">
                                                                                    </div>
                                                                                    <div class="form-group" style="margin-left: 4%;margin-right: 4%;">
                                                                                        <input type="text" placeholder="URL"  name="slug" style="background-color: #fff;" class="form-control">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <div class="col-sm-offset-2 col-sm-10">
                                                                                            <div class="pull-right">
                                                                                                <input type="hidden" value="external">
                                                                                                <button style="margin-bottom: 10%;" type="button" onclick="addExternalPage(this)" class="btn btn-primary">Save</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse" data-parent="#menu_accordion" href="#collapseFive"><span style="padding-right: 1%;"  class="glyphicon glyphicon-heart">
                                                         </span>Static</a>
                                                                            </h4>
                                                                        </div>
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <div class="form-inline">
                                                                            <b>{{ 'Header' }}</b>
                                                                            <button type="button" onclick="saveHeaderMenu()" style="padding: 1px 12px;" class="pull-right btn btn-primary saveHeaderMenu">Save Menu</button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="panel-body">
    ...
    <script>
        ...
        function addPageToMenu(element){
            ...
            if(pages.length == 0){
                ...
                $.post('{{ route('addToHeaderMenu') }}',{_token:'{{ csrf_token() }}',page_arr:pages},function(data){
                    $('#status').remove();
        ...
        function saveHeaderMenu()
        {
            ...
            $('#main > .menu-box > .menu-list > li').each(function(key,value){
                ...
                if ($(value).find('ul')) {
                    ...
                    $(value).children('ul').children('li').each(function(k,v){
                        child_arr = {'id': $(v).data('id'),'title':$(v).children('a').text(),'url' : $(v).data('url'), 'type' : $(v).data('type') };
                        final_child.push(child_arr);
                    });
                    menu_arr = {'parent_type': $(value).data('type') ,'parent_id':  $(value).data('id'),'child' : final_child,'title': title,'parent_url':$(value).data('url')};
            ...
            $.post('{{ route('postHeaderMenu') }}',{_token:'{{ csrf_token() }}',content:content,final_arr:final_arr},function(data){
                if(data == 'ok'){
                    $('#status').remove();
